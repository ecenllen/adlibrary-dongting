...
public class DownLoaderAPK {
    ...
    private DownLoaderAPK() {
        ...
        baseDir = weakContext.get().getCacheDir().getAbsolutePath() + "/apk/";
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case 2000: // 更新界面
                {
                    ...
                    String filePath = baseDir + info.getAd_packagename() + "_" + info.getAd_versioncode() + ".apk";
                    PackageUtil.installNormal(weakContext.get(), filePath);
                }
                break;
                case 3000: // 出了问题了
                {
                    ADBean info = (ADBean) msg.obj;
                    Toast.makeText(weakContext.get(), info.getAd_name() + "下载失败", Toast.LENGTH_SHORT).show();
                }
                break;
                default:
                    break;
