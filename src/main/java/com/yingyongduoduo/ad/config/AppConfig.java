...
//            } catch (Exception e) {
            try {
                downloadjar(configbaseURL1 + "video/aitool.jar", aitoolPath);
            } catch (Exception e1) {
                try {
                    downloadjar(configbaseURL2 + "video/aitool.jar", aitoolPath);
                } catch (Exception e2) {
                    try {
                        downloadjar(configbaseURL3 + "video/aitool.jar", aitoolPath);
                    } catch (Exception e3) {//这一步则表示下载失败
                        isSuccess = false;
                    }
                }
